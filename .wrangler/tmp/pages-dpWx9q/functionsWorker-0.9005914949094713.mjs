...
// api/promo.ts
var json4 = /* @__PURE__ */ __name((data, status = 200) => new Response(JSON.stringify(data), {
  status,
  headers: { "Content-Type": "application/json; charset=utf-8" }
}), "json");
...
// ../.wrangler/tmp/pages-dpWx9q/functionsRoutes-0.05917259622888338.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-0sJoWm/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-0sJoWm/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.9005914949094713.mjs.map
