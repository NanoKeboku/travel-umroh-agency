 ...
 * Status: KERANGKA — siap diisi (nomor WA diambil dari src/data/kontak.ts)
 */
...
function FloatingWhatsApp() {
  return (
    <a
      href={waLink('Halo Ebitour, saya ingin bertanya tentang paket umrah')}
      target="_blank"
    ...
    >
      {/* Ikon WhatsApp (placeholder teks — ganti dengan SVG) */}
